...
//        4. 임의 객체 인스턴스 메서드 참조
        String[] names = { "seungah", "bokyeong", "seungbeom" };

//        Function<String, String> toUpperFunc = s -> s.toUpperCase();
        Function<String, String> toUpperFuncRef = String::toUpperCase;

        for(String name: names) {
//            호출 시점(apply)에 매개변수로 들어온 객체의 메서드 호출
            String upper = toUpperFuncRef.apply(name);
