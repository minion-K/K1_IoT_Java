...
* : 함수형 인터페이스 "구현"에 사용 (Java 8 도입)
* - 함수를 하나의 식으로 간결하게 표현
* - 익명클래스를 대체하여 코드의 가독성을 향상
* 
* cf) 함수형 인터페이스
...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        Calculator calculator2 = (a, b) -> {
            int result = a + b;
            return result; // 여러 줄 구현은 중괄호 생략 불가능 (반환값도 반드시 return 사용)
        };
