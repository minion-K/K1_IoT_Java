...
//        사칙 연산 (덧셈, 뺄셈, 곱셈, 나눗셈)
        ...
        System.out.println(a % b); // 나눗셈 (5): 나눈 결과의 나머지를 저장
...
//        해당 값의 연산 후 다시 변수에 할당
        System.out.println(number += 3); // number + 3의 결과를 number에 할당 (number = number +3)
...
//        : 조건식(논리의 값이 반환) ? 조건식이 참인 경우 반환 : 조건식이 거짓인 경우 반환
        ...
        int x = 10, y = 3; // 변수의 데이터타입이 같은 경우 ,(콤마)로 구분하여 나열 가능
