...
// - 객체 내부의 구현을 숨기고, 외부에서는 제동된 메서드를 통해서만 접근하도록 설정
...
//    cf) setter는 단순한 데이터 설정 뿐만 아니라, 데이터의 검증 역할을 담당하기도 한다.
...
//        student.name = "이승아"; - private 설정 (해당 클래스 외에서는 접근 불가)
        ...
        student.setScore(100); // 유효하지 않은 점수입니다.
...
// cf) _(언더스코어)와 -(하이픈)의 차이

// ctrl + 좌우 방향키: 단어별 이동
// ctrl + shift + 좌우 방향키 = 단어별 드래그
// a_hello
// : 가동성을 위한 단어의 구분 (단어가 1개)
