...
// - 동일한 키에 서로 다른 값 전당 시 기존 값이 새로운 값으로 덮어씌어짐
...
//        values(): Map의 값들을 컬렉션 타입으로 반환
        ...
        System.out.println(listAges); // [25, 20] - Collection<Integer> 타입

//        cf) Collection 타입은 하위 인터페이스 형태로 변환 가능
