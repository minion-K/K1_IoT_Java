...
//     : 미만일 경우 "홈런상 후보에 등록될 수 없습니다." 반환
    ...
    void updateStatus(double newBattingAverage, int newHomeRuns){
        // 필드값과 매개변수명이 충돌나지 않기 때문에 this 키워드 생략가능
...
//       인스턴스 생성
        BaseballPlayer player1 = new BaseballPlayer("권민현", 0.325, 16);
        BaseballPlayer player2 = new BaseballPlayer("이지훈", 0.295, 20);
        BaseballPlayer player3 = new BaseballPlayer("김민혁", 0.301, 11);
        BaseballPlayer player4 = new BaseballPlayer("강경훈", 0.292, 21);
