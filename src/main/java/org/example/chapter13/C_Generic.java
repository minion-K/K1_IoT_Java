...
* 
* 4) list.add(value)이 안되는 이유
*   : 와일드카드는 타입이 불확실해서 안정성 문제로 컴파일이 값의 할당을 막음
* */

// == 주문 관리 시스템 ==
// 상품(Product)와 할인(Discount) 정보를 관리
// : 할인 정책 사용시 , Product 또는 Product를 상속받는 하위 클래스(Electronics / Furniture)에서만 적용
...
//        리스트 컬렉션 프레임워크에 Product 타입을 가지거나, 
...
public class C_Generic {
    public static void main(String[] args) {
        ...
        double totalEletronics = DiscountPolicy.applyDiscount(electronics,0.1);
        System.out.println("총 가전 할인액: "+ totalEletronics + "원"); // 총 가전 할인액: 31.8원
