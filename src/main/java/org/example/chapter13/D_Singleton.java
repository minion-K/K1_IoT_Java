...
//    싱글톤 패턴의 전역 접근성을 제공하는 메서드 정의(인스턴스와 담당)
...
//            객체가 없다면 새로 생성
        ...
        return instance; // 기존 객체(if가 false) or 생성 객체 반환(if가 true)
    }
...
//        instance == null (true)
//        : 새로운 객체 생성
        SchoolPrincipal schoolPrincipal1 = SchoolPrincipal.getInstance();
        
//        기존의 instance 주소를 반환
        SchoolPrincipal schoolPrincipal2 = SchoolPrincipal.getInstance();
        SchoolPrincipal schoolPrincipal3 = SchoolPrincipal.getInstance();
        SchoolPrincipal schoolPrincipal4 = SchoolPrincipal.getInstance();

        System.out.println(schoolPrincipal1);
        System.out.println(schoolPrincipal2);
        System.out.println(schoolPrincipal3);
        System.out.println(schoolPrincipal4);
        ...
        System.out.println(example4); // org.example.chapter13.Example@3d075dc0

        System.out.println(schoolPrincipal1 == schoolPrincipal2); // true

        schoolPrincipal1.announce();
