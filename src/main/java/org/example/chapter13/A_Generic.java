...
*       , 해당 기능 사용 시 작성되는 실질적은 타입이 전달외어 사용
*
*       <T>: Type의 약자 (가장 흔하게 사용)
...
//              >> 타입 소거(Type Erasure)
        ...
        list.add("Hello");
//        컴파일 시 리스트 내부요소가 String 인지 검사
//        >> 런타임 시에는 List<String>dl List로 취급됨 (타입 정보는 사라짐)
