...
// == 자바의 정적 배열 == 
// 장점)
// : 기본 데이터 타입 사용 가능 - int, char, boolean 등
// : 요소 접근 속도가 빠름 (인덱스 기반)
// 단점)
// : 한 번 생성되면 크기 변경 X
...
//        == 자바 동적 배열 (ArrayList) == 
//        : Java의 동적 배열 구현체 (내부적으로 배열을 사용하지만 자동으로 크기 조절)
...
//        1. ArrayList 테이터 추가: 배열의 마지막에 값을 추가
//        - 배열명.add(추가할 데이터);
        arrayList.add(10);
        arrayList.add(20);
        arrayList.add(30);
...
//        >> 내부 데이터를 확인하기 쉽게 문자열로 정리된 상태 제공 toString() 재정의
