...
public class StudentManagement {
    public static void main(String[] args) {
        ...
        dummyStudent.add(new Student(1, "이승아", 25, "1111"));
        dummyStudent.add(new Student(2, "이도경", 29, "2222"));
        dummyStudent.add(new Student(3, "조승범", 30, "3333"));
        dummyStudent.add(new Student(4, "김명진", 32, "4444"));
