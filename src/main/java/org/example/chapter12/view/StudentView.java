...
//                    : 기존의 case + break 문법을 대체하여 각 case만 실행하는 문법
                    ...
                    case 6 -> {
//                        switch-case 문의 화살표 문법에서 여러 줄의 코드 작성 시 {} 중괄호로 범위를 감싸야 한다.
                ...
                System.out.println("⚠️잘못된 입력입니다. 숫자를 입력해주세요");
            } catch (Exception e) {
                System.out.println("⚠️오류가 발생했습니다: " + e.getMessage());
            }
...
//        모든 클래스 타입의 Object 클래스 타입을 상속 받음
