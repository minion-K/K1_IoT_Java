...
//        cd) for 문으로 1부터 5까지 출력하는 문장을 작성(초기화는 1)
...
//        초기화
        ...
        while (true) { //ifans & while문의 조건식은 결과값이 논리형(boolean)
//            : while문은 조건식을 true 값으로 고정하는 경우
//              , 종료 시점(break)을 개발자가 직접 명시하지 않으면 무한 루프 (무한루프 종료 ctrl + F2)
//            >> 프로그램의 과부하 방지를 위해 지양
            if (number % 2 == 0) {
//                짝수
