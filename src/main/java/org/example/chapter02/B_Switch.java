...
//        : 비교할 변수와 case 값을 비교하여 같은 값일 결우 해당 블록부터 끝까지 실행
...
//              System.out.prinfln("안녕"); - 해당 내용 출력 X
            case 2:
                System.out.println("자바 제어문 - 조건문/반복문");
                System.out.println("switch - case 학습");
                break;
            case 3:
...
//        >> 조건이 다양하거나 논리식이 필요할 경우
        int score = 85;
        if(score >= 90) System.out.println("우수한 성적입니다.");
        else if(score  >= 70) System.out.println("평균적인 성적입니다.");
        else System.out.println("조금 더 노력해 봅시다.");
//        2. switch문
//        - 사용 대상: 정해진 값 비교
...
//        >> 정확히 일치하는 값 비교할 경우
        ...
        switch (grade) {
            case "A": case "B":
                ...
                break; // A와 B 등급이 같은 결과를 출력: case문을 한 줄에 연달아 사용 가능
            case "C": case "D":
