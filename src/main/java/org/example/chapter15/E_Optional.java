...
//        1. Optional 클래스
//        : null이 아닌 값을 포함하거나, 값이 없는 상태를 나타낼수 있음
...
//        2) Optional.ofNullable(T value): null 여부 상관 없이 Optional 생성 (null일 경우 빈 Optional)
        Optional<String> optional2 = Optional.ofNullable(null);

//        3) Optional.empty(): 비어있는 Optional 생성 (명시적으로 "값이 없음"을 표현)
...
//        5. Optional 기본값 처리
//              >> 값을 확인하고 존재하면 반환, 존재하지 않으면(빈 Optional) 경우에 따라 값을 반환 || 예외 발생
