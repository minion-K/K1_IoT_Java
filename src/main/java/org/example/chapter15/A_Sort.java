...
* 3. 리스트(List 인터페이스) 정렬
* : Collections.sort()
* - Collections.sort() || List 인터페이스의 sort() 사용
* */
...
//              >> 어떤 기준으로 정렬할 지 개발자가 결정

//        [3] 스트림 API 사용 정렬
//        : 정렬된 결과를 "새로운 컬렉션"으로 반환
...
//        >> 스트림 API를 사용한 정렬 시, 원본 데이터에 대한 불변성이 유지!
//              , 새로 정렬된 리스트를 반환
