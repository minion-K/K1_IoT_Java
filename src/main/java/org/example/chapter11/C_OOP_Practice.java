...
/*
* === SOLID 원칙 ===
* SRP: 단일 책임 원칙 - 클래스는 하나의 책임만을 가진다
* OCP: 개방 폐쇄 원칙 - 확장에 개방, 수정에 폐쇄
* LSP: 리스코프 치환 원칙 - 자식 클래스는 부모 클래스는 대체 할 수 있다 (부모와 행위의 일광성)
...
class CreditCardPaymentProcessor implements PaymentProcessor {
    ...
    public void processPayment(Order order) {
        System.out.println("신용 카드로 결제합니다: " + order.getOrderId());
    }
}
...
public class C_OOP_Practice {
    public static void main(String[] args) {
        ...
        PaymentProcessor samaungPayPaymentProcessor = new SamsungPayPaymentProcessor();
        ...
        OrderService orderService2 = new OrderService(samaungPayPaymentProcessor, generateReport);
