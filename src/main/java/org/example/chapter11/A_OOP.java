...
// >> 다양한 디자인 패턴(Design Pattern)이 SOLID 설계 원칙에 따라 만들어짊

// cf) 디자인 패턴
//      : 소프트웨어 개발 과정에서 자주 발행하는 문제들에 대한 일반적인 해결책

// cf) SOLID 원칙 적용 시 주의사항
//      : 적용 순서 X
//      : 모두 적용 X
//      : 서로 독립적 개념 X - 개념적으로 연관 O
//      - 상속, 캡슐화, 추상화, 다형성은 OOP의 네 가지 특성

// 1. SRP(Single Responsibility Principle, 단일 책임 원칙)
// - 클래스는 단 하나의 책임만을 가져야 함
// - 한 가지 역할(기능)만 담당 / 하나의 변화 이유만을 가져야 함
// >> 하나의 클래스가 가지는 하나의 역할과 관련된 변경사항만 클래스의 영향을 미쳐야 함

// 1) 잘못된 설계 예제 - 하나의 클래스가 여러개의 책임
class SchoolHelper {
    void cleanClassroom() {
...
// : 소프트웨어 엔티티(클래스, 모듈, 함수 등)는 확장에는 열려 있어야 하고, 수정에는 닫혀있어야 한다.
