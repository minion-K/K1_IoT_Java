...
//        상수 키워드는 클래스의 static final 필드 처럼 쓰임
//        : Enum명.데이터;
...
//        : 잘못된 문자열 정달 시 IllegalArgumentException 발생
...
//        === CoffeeSize ===
        ...
        CoffeeSize otherSize = CoffeeSize.LARGE;
        System.out.println(otherSize + "'s ml: " + otherSize.getMl()+ "ml"); // LARGE's ml: 300ml
    }
}
